...
{
	// 주요 속성 구성 → 특정 클래스 타입이 아닌... 인터페이스 타입(Record = 인터페이스 타입)
	...
	public void output()
	{
		...
		System.out.printf("%6d %5d %5d %6d %6.1f%n", record.getKor(), record.getEng(), record.getMat(), record.getTotal(), record.getAvg());
	} 
}
